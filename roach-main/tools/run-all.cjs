...
const ALL=['check-browser.cjs','check-pan.cjs','test-round1.cjs','test-lab.cjs','test-round2.cjs','test-layout.cjs','test-perf.cjs','test-letters.cjs','test-watchcam.cjs','test-mobile.cjs'];
